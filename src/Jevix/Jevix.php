 ...
 * @author Livestreet team, http://livestreet.ru
...
class Jevix
{
    ...
    protected function makeAutoReplaces()
    {
        $replaces = $this->configuration->getAutoReplaces();
        if (!empty($replaces)) {
            $this->text = str_ireplace($replaces['from'], $replaces['to'], $this->text);
        }
    }
    ...
    /**
     * Sets automated replacement of newlines with <br />
     *
     * @deprecated
    ...
    protected function goToPosition($position){
        ...
        if($this->curPos < $this->textLen){
            ...
            $this->curChOrd = Util::uniord($this->curCh);
